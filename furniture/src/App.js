  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="Comparison" element={<BaseLayout><Comparison /></BaseLayout>} />
        <Route path="Product" element={<BaseLayout><Product /></BaseLayout>} />
        <Route path="Ascart" element={<BaseLayout><Ascart /></BaseLayout>} />
        <Route path="Osscart" element={<BaseLayout><Osscart /></BaseLayout>} />
